...
function pickBG() {
	...
	if (IDnum == "1") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/DPk.png')";
	} else if (IDnum == "2") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Red.png')";
	} else if (IDnum == "3") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Orange.png')";
	} else if (IDnum == "4") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Gold.png')";
	} else if (IDnum == "5") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Yellow.png')";
	} else if (IDnum == "6") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Green.png')";
	} else if (IDnum == "7") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Grass.png')";
	} else if (IDnum == "8") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Cloud.png')";
	} else if (IDnum == "9") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/bbBlue.png')";
	} else if (IDnum == "10") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Water.png')";
	} else if (IDnum == "11") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Grape.png')";
	} else if (IDnum == "12") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Pink.png')";
	} else if (IDnum == "13") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/DarkPurp.png')";
	} else if (IDnum == "14") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/rainbow.gif')";
	} else if (IDnum == "15") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/VDarkPurp.png')";
	} else if (IDnum == "16") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Teal.png')";
	} else if (IDnum == "17") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Pumpkin.png')";
	} else if (IDnum == "18") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Black.png')";
	} else if (IDnum == "19") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/DGrey.png')";
	} else if (IDnum == "20") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Grey.png')";
	} else if (IDnum == "21") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/DarkRed.png')";
	} else if (IDnum == "22") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/DarkGreen.png')";
	} else if (IDnum == "23") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/Blueberry.png')";
	} else if (IDnum == "24") {
		document.getElementById("mainHTML").style.background = "url('/backgrounds/ClassicColors.png')";
	} else {
...
function ConnectLounge() {
	...
	document.getElementById("mainHTML").style.background = "url('/backgrounds//Royalty.png')";
	socket.emit("join", "˜”*°•.˜”*°• 𝓐𝓭𝓶𝓲𝓷 𝓛𝓸𝓾𝓷𝓰𝓮 •°*”˜.•°*”˜", myUser);
}
function ConnectPub() {
	rawUser = usernameInput.value
	myUser = rawUser.split(' ').join('_');
	socket.emit("join", "Public Room", myUser);
	postMessage("You have joined a public room. Please be respectful and do not send offensive content.")
}
...
function copyRoomLink() {
	const toCopy = "/?room=" + encodeURIComponent(document.getElementById("IDInput").value)
